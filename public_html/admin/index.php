...
require __DIR__ . '/../../WickkStudio/backend/config/bootstrap.php';

$config = yii\helpers\ArrayHelper::merge(
    require __DIR__ . '/../../WickkStudio/common/config/main.php',
    require __DIR__ . '/../../WickkStudio/common/config/main-local.php',
    require __DIR__ . '/../../WickkStudio/backend/config/main.php',
    require __DIR__ . '/../../WickkStudio/backend/config/main-local.php'
);
